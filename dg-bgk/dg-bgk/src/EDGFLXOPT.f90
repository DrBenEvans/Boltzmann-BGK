...
!     COMMUNICATION STUFF (OPTIMIZATION)
      ...
      REAL :: SEND_EDGE_DATA(10000)!
      REAL :: RECV_EDGE_DATA(10000)!
      INTEGER :: SEND_EDGE_DATA_IDX(10000)! LOCAL EDGE INDICES ON OPPOSITE MPI_RANK_P    
      INTEGER :: RECV_EDGE_DATA_IDX(10000)! LOCAL EDGE INDICES ON CURRENT MPI_RANK_P
      INTEGER :: EDGCOUNT
